...
def main():
    st.set_page_config(page_title="Customer Segmentation Dashboard - created by Ahmed Gbadamassi", layout="wide")
    st.title("Customer Segmentation Dashboard - created by Ahmed Gbadamassi")
    st.markdown(
        """
